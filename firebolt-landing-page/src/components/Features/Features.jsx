            ...
            <div className='grid  md:grid-cols-4 grid-cols-2 gap-4 mt-10 mx-4'>
                <div className='w-full bg-gray-100 rounded-md  border-2 flex justify-center py-3'>
                    <div className='flex gap-3 '>
                        <img className='h-14' src="https://res.cloudinary.com/dhturqqs5/image/upload/v1722355630/Firebolt-landing-page/ic5lcp0hknvmtk89sdfl.webp" alt="" />
                        <div>
                ...
                <div className='w-full bg-gray-100 rounded-md  border-2 flex justify-center py-3'>
                    <div className='flex gap-3 '>
                        <img className='h-14' src="https://res.cloudinary.com/dhturqqs5/image/upload/v1722355683/Firebolt-landing-page/rnkolrx5zt3rflwvw4mf.webp" alt="" />
                        <div>
                ...
                <div className='w-full bg-gray-100 rounded-md  border-2 flex justify-center py-3'>
                    <div className='flex gap-3 '>
                        <img className='h-14' src="https://res.cloudinary.com/dhturqqs5/image/upload/v1722355744/Firebolt-landing-page/iyijxuaspvjttodhfuxr.webp" alt="" />
                        <div>
                ...
                <div className='w-full bg-gray-100 rounded-md  border-2 flex justify-center py-3'>
                    <div className='flex gap-3 '>
                        <img className=' h-14' src="https://res.cloudinary.com/dhturqqs5/image/upload/v1722355780/Firebolt-landing-page/zlsyuqlpam2yye9ibkdu.webp" alt="" />
                        <div>
